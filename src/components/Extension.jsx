  ...
  return (
    <section className="flex min-h-50 flex-col justify-between rounded-2xl bg-(--COLOR-BG-CARD-PRIMARY) px-4.5 py-5 font-(family-name:--FF) shadow-(--SHADOW-CARD-SECONDARY) motion-safe:transition-colors motion-safe:duration-300 motion-safe:ease-in-out">
      ...
      <div className="flex items-center justify-between">
        <button
          className="cursor-pointer rounded-full border border-solid border-(--COLOR-BORDER-SECONDARY) px-4 py-1.75 text-[0.95rem] font-medium select-none motion-safe:transition-colors motion-safe:duration-300 motion-safe:ease-in-out"
          type="button"
        >
          Remove
        </button>
